...
namespace MiniIPC
{
    ...
    {
        static readonly Dictionary<Type, Type> proxyImplementations = new Dictionary<Type, Type>();

        static readonly Dictionary<Type, Dictionary<string, int>> receiverProxyCommandMaps =
            new Dictionary<Type, Dictionary<string, int>>();

        static readonly Dictionary<Type, Type> receiverProxyImplementations = new Dictionary<Type, Type>();
        static readonly Dictionary<Type, MethodInfo> receiverProxyInvokeMethods = new Dictionary<Type, MethodInfo>();

        public static InvokeMethodDelegate CreateReceiverProxy<T>(T service,
                                                                  out object instance,
                                                                  out Dictionary<string, int> methodMap)
        {
            ...
            return (InvokeMethodDelegate) Delegate.CreateDelegate(typeof(InvokeMethodDelegate), instance,
